  ...
  init: async function() {
    ...
    toys.map(toy => {
      ...
      if (!toy.is_out_of_stock) {
        ...
        titlePlane.setAttribute("position", { x: 0, y: 1, z: 0.08 });
        titlePlane.setAttribute("rotation", { x: 0, y: 0, z: 0 });
        titlePlane.setAttribute("width", 2);
        titlePlane.setAttribute("height", 0.5);
        titlePlane.setAttribute("material", { color: "white" });
        mainPlane.appendChild(titlePlane);

        var toyTitle = document.createElement("a-entity");
        toyTitle.setAttribute("id", `toy-title-${toy.id}`);
        toyTitle.setAttribute("position", { x: 1, y: 0, z: 0.1 });
        ...
        price.setAttribute("position", { x: -0.7, y: 0.7, z: 0.1 });
        ...
        age.setAttribute("position", { x: -0.8, y: -0.8, z: 0.1 });
